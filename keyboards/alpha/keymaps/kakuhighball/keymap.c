...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[FKEYS] = LAYOUT(
		...
		KC_F11,KC_F12,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_PAUS,KC_PSCR,KC_DEL,
		KC_LCTL, MO(4), KC_TRNS, KC_TRNS, MT(MOD_LSFT, KC_SPC), KC_RGUI, KC_RALT, KC_RCTL),

	[4] = LAYOUT(
		RGB_TOG, RGB_MOD, RGB_RMOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_F8, KC_F9, KC_F10,
		KC_NO, KC_NO, KC_NO, RGB_HUD,RGB_SAD,RGB_VAD,RGB_SPD,KC_NO,KC_NO,KC_DEL,
